...
abstract class ListRefreshFragment<P : BasePresent<*>, M, D : ViewDataBinding> :
    MvpBindindFragment<P, D>(), OnRefreshListener, OnLoadMoreListener, RefreshBaseView<M> {
