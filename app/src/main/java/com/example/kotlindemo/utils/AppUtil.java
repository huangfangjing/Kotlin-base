...
public class AppUtil {
    ...
    public static boolean isEnableV19(Context context) {
        ...
        try {
            ...
            AspLog.e(TAG,"异常信息" + e.getMessage());
    ...
    public static String getMetaValue(Context context, String metaKey) {
        ...
        try {
            ...
            AspLog.e(TAG,"获取清单" + metaKey + "的值错误");
        }
    ...
    public static String getMacAddress(Context context) {
        try {
            ...
            AspLog.e(TAG,"错误信息" + TAG + " getMacAddress :" + e.getMessage());
            return null;
        }
    }
    ...
    public static boolean isLocServiceEnable(Context context) {
        ...
        if (gps || network || (!TextUtils.isEmpty(status) && status.contains("gps"))) {
            return true;
        }
        return false;
    }
...
//			AspLog.e(TAG, "flags:" + info.flags + " flag debug:" + ApplicationInfo.FLAG_DEBUGGABLE);
//			AspLog.e(TAG, "flag:" + (info.flags & ApplicationInfo.FLAG_DEBUGGABLE) );
...
//以下方法才能兼容android:label="${APP_NAME}"并取得应用名称，其中APP_NAME在打包过程中会直接赋值为应用名称
        ...
        try {
            ...
            AspLog.i(TAG, "getAppName >> e:" + e.toString());
        }
        return null;
    }
...
//        ClipboardManager cbManager = (ClipboardManager) MyApplication.getContextObject().getSystemService(Context.CLIPBOARD_SERVICE);
...
//        AspLog.d("jsonjson", "packageName:" + packageName + "   processName:" + processName + " " + packageName.equals(processName));
    ...
    private static long getStatFsTotalSize(String path) {
        ...
        AspLog.d(TAG, "getStatFsTotalSize path:" + path + " totalSize:" + totalSize);
    ...
    private static long getStatFsAvailableSize(String path) {
        ...
        long totalSize = blockSize * blockCount;
        AspLog.d(TAG, "getStatFsAvailableSize path:" + path + " availableSize:" + totalSize);
    ...
    public static boolean isTopActivity(Activity activity) {
        Activity mActivity = ActivityStack.getScreenManager().currentActivity();
    ...
    public static String getDefaultInputMethodPkgName(Context context) {
        ...
        //输入法类名信息
        AspLog.d(TAG, "mDefaultInputMethodCls=" + mDefaultInputMethodCls);
        if (!TextUtils.isEmpty(mDefaultInputMethodCls)) {
            //输入法包名
            mDefaultInputMethodPkg = mDefaultInputMethodCls.split("/")[0];
            AspLog.d(TAG, "mDefaultInputMethodPkg=" + mDefaultInputMethodPkg);
        }
    ...
    public static void setDefaultInputMethod(Context context, String inputType) {
        ...
        AspLog.e(TAG,"：" + String.format("输入法设置,result: %s", value, success));
